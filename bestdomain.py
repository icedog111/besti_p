...
if __name__ == "__main__":
    ...
    subdomain_ip_mapping = {
        'bestcf': 'https://ipdb.60285798.xyz/api/bestcf.txt',  # #域名一，bestcf.域名.com
        'api': 'https://raw.githubusercontent.com/icedog111/besti_p/refs/heads/main/ip.txt', #域名二，api.域名.com
        # 添加更多子域名和对应的IP列表URL
    }
